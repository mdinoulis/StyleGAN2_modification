...
def run(dataset, data_dir, result_dir, config_id, num_gpus, total_kimg, gamma, mirror_augment, metrics, batch_size):
...
def main():
    ...
    parser.add_argument('--batch-size', help='Minibatch size (default: %(default)s)', default=32, type=int, metavar='N')
